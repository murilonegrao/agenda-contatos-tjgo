...
type: project-doc
tags: [projeto, pi2a, requisitos, user-stories, casos-de-uso, agenda-tjgo]
status: v0.1
criado: 2026-06-15
...
> Etapa **1 — Levantamento de requisitos**. Esta spec cobre a aplicação **console** — a entrega acadêmica. Modelo de dados em [v0.1-data-model](v0.1-data-model.md), estrutura de classes em [v0.1-classes](v0.1-classes.md). Hub em [README](README.md).
...
| **RNF04 — Tecnologia exigida** | Java 17+, JDBC puro, PostgreSQL 18, build Maven, IDE NetBeans | ver [ADR-001-stack](ADR-001-stack.md) |
